...
function(a){return this.filter(a).first()};c.prototype.min=function(){return this.reduce(function(a,b){return"undefined"===typeof a?b:b<a?b:a})};c.prototype.max=function(){return this.reduce(function(a,b){return"undefined"===typeof a?b:b>a?b:a})};c.inherit=function(a){var b=function(){c.call(this,arguments[0]);a.apply(this,arguments)};b.prototype=c.prototype;return b};var e=c.inherit(function(a){var b;this.cache=function(){b||(b=this.toArray());return b};this.get=function(a){return this.cache()[a]};
this.length=function(){return this.cache().length}});e.inherit=function(a){var b=function(){e.call(this,arguments[0]);a.apply(this,arguments)};b.prototype=e.prototype;return b};var h=c.inherit(function(a,b){this.get=function(d){return b(a.get(d))};this.each=function(d){a.each(function(a){return d(b(a))})}}),l=e.inherit(function(a,b){this.each=function(d){a.each(function(a){if(b(a))return d(a)})}}),r=c.inherit(function(a){this.get=function(b){return a.get(a.length()-b-1)};this.length=function(){return a.length()};
this.each=function(b){for(var d=a.length()-1;0<=d&&!1!==b(a.get(d));--d);}}),s=e.inherit(function(a,b){this.each=function(d){var c=0;a.each(function(a){a=d(a);return++c>=b?!1:a})}}),t=e.inherit(function(a,b){this.each=function(d){var c=0;a.each(function(a){if(!(c++<b))return d(a)})}}),u=e.inherit(function(a,b){this.each=function(d){var c=a.toArray();c.sort(function(a,d){return n(a,d,b)});p(c,d)}}),v=e.inherit(function(a,b){this.each=function(d){var c={};a.each(function(a){var d=b(a);c[d]?c[d].push(a):
c[d]=[a]});for(var k in c)d([k,c[k]])}}),w=e.inherit(function(a,b){this.each=function(d){var c={};a.each(function(a){a=b(a);c[a]=c[a]?c[a]+1:1});for(var k in c)d([k,c[k]])}}),x=e.inherit(function(a){this.each=function(b){var c={};a.each(function(a){if(!(a in c))return c[a]=!0,b(a)})}}),B=e.inherit(function(a,b){this.each=function(c){var f=new m(b);a.each(function(a){if(!f.contains(a))return c(a)})}}),C=e.inherit(function(a,b){this.each=function(c){var f=new m;a.each(function(a){f.contains(a)||(f.add(a),
c(a))});Lazy(b).flatten().each(function(a){f.contains(a)||(f.add(a),c(a))})}}),D=e.inherit(function(a,b){this.each=function(c){var f=Lazy(b).map(function(a){return new m(a)}).toArray();a.each(function(a){for(var b=0;b<f.length;++b)if(!f[b].contains(a))return;c(a)})}}),y=e.inherit(function(a,b){this.each=function(c){var f=0;a.each(function(a){a=[a];for(var e=0;e<b.length;++e)b[e].length>f&&a.push(b[e][f]);++f;return c(a)})}}),z=e.inherit(function(a){this.each=function(b){for(var c=a.toArray(),f=c.length-
1;0<f;--f){var e=c,g=Math.floor(Math.random()*f)+1,h=e[f];e[f]=e[g];e[g]=h;if(!1===b(c[f]))return}b(c[0])}}),A=e.inherit(function(a){this.each=function(b){a.each(function(a){return a instanceof Array?q(a,b):b(a)})}}),E=c.inherit(function(a){c.call(this);this.get=a;this.length=function(){throw"Cannot get the length of a generated sequence.";};this.each=function(b){for(var c=0;!1!==b(a(c++)););}});g.Lazy=function(a){return a instanceof c?a:new c(null,a)};g.Lazy.generate=function(a){return new E(a)};
g.Lazy.range=function(){var a=1<arguments.length?arguments[0]:0,b=1<arguments.length?arguments[1]:arguments[0],c=2<arguments.length?arguments[2]:1;return this.generate(function(b){return a+c*b}).take(Math.floor((b-a)/c))};var m=function(a){var b={};Lazy(a||[]).flatten().each(function(a){b[a]=!0});this.add=function(a){b[a]=!0};this.contains=function(a){return b[a]}}})("undefined"===typeof exports?window:exports);
